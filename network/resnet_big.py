...
class SupConResNet(nn.Module):
    def __init__(self, name='resnet18', head='mlp', feat_dim=128, num_classes=1000):
        ...
        # Projection head
        if head == 'linear':
            self.projection_head = nn.Linear(dim_in, feat_dim)
        elif head == 'mlp':
    ...
    def forward(self, x, train_mode=True):
        ...
        if train_mode:
            ...
            feat = self.classification_head(feat)
